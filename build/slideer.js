...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Slideer; });
...
function () {
  ...
  _createClass(Slideer, [{
    key: "init",
    value: function init() {
      this.hammer = new hammerjs__WEBPACK_IMPORTED_MODULE_0___default.a.Manager(this.el);
      this.hammer.add(new hammerjs__WEBPACK_IMPORTED_MODULE_0___default.a.Swipe({
        direction: hammerjs__WEBPACK_IMPORTED_MODULE_0___default.a.DIRECTION_HORIZONTAL
      }));
